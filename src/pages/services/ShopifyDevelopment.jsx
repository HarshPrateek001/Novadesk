...
export default function ShopifyDevelopment() {
  ...
  const faqs = [
    {
        "q": "Why should we choose NOVADESK for Shopify Dev?",
        "a": "We bring deep engineering expertise without the agency bloat. You get direct access to senior developers who understand both the technical and business sides of Shopify Dev."
    },
    {
  ...
  return (
    <>
      <SEO 
        title="Shopify Dev Services | NOVADESK"
        description="Expert Shopify Dev tailored for startups and enterprises. We build secure, scalable, and high-performance solutions. Get a free consultation today."
        url="/services/shopify-development"
        keywords="shopify dev, custom shopify dev, ecommerce development company, hire developers"
        schema={schemaJson}
      />
        ...
        <section className="fs-hero">
          <div className="fs-container fs-hero-grid">
            <div className="fs-hero-text">
              ...
              <h1 className="fs-hero-title">Shopify</h1>
              <span className="fs-hero-title-blue">Dev</span>
              <p className="fs-hero-desc">
                NOVADESK delivers professional Shopify Dev solutions designed to scale. From architecture to deployment, we build high-performance systems for modern businesses.
              </p>
            ...
            <div className="fs-hero-image-wrapper">
              <img src="/hero_illustration.webp" alt="ShopifyDevelopment Team" className="fs-hero-image" />
            </div>
          </div>
        </section>
          ...
          <div className="fs-container">
            <div className="fs-split-header">
              <div>
                ...
                <h2>What's Included in Our Shopify Dev Services</h2>
              </div>
              <p>
                We cover the entire lifecycle of Shopify Dev. Our modular approach ensures that your product is secure, fast, and easy to maintain as your business grows.
              </p>
            </div>
          ...
          <div className="fs-container">
            <div className="fs-api-cta-top">
              <div className="fs-api-cta-left">
                <h2>Scale Faster With Our<br/>Shopify Dev Expertise</h2>
              </div>
              <div className="fs-api-cta-right">
                <p>Partner with a team that understands the nuances of Shopify Dev. We build architectures that support millions of users without breaking a sweat.</p>
          ...
          <div className="fs-container">
            <div className="fs-process-header-wrap">
              <div className="fs-process-header-left">
                ...
                <h2>Inside Our Shopify Dev<br/>Process</h2>
              </div>
