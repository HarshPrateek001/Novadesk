      ...
      <div className="fs-page">
          ...
          <div className="fs-container fs-hero-grid">
            <div className="fs-hero-text">
              <h1 className="fs-hero-title">
                Full Stack <span className="fs-text-blue">Development</span><br />
                <span className="fs-text-blue">Services</span>
              </h1>
        ...
        <section className="fs-trust">
          <div className="fs-container">
            <p>Full Stack Development Services, Backed by <span className="fs-text-blue">Leading Brands</span></p>
          </div>
