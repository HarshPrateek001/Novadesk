        ...
        <div className="nd-footer-top">
          ...
          <div className="nd-footer-logo-area">
            ...
            <div className="nd-footer-socials">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="nd-footer-social-btn"><LinkedInIcon /></a>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="nd-footer-social-btn"><InstagramIcon /></a>
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="nd-footer-social-btn"><FacebookIcon /></a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="nd-footer-social-btn"><YoutubeIcon /></a>
            </div>
          </div>
